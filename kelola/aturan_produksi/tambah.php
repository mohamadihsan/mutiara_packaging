...
Headers();
?>
	<title>Tambah Aturan Produksi</title>
			...
			<div class="box box-default">
				<div class="box-body">
		      		<div class="row">
						...
						<div class="box-body">
							<form method="post" action="../aturan_produksi/" enctype="multipart/form-data">
					        	<!-- /.box-header -->
					        	<div class="box-body">
				            		<div class="col-md-8">
					              		<div class="col-md-12">
					              			<div class="form-group">
												...
												<select class="form-control select2" style="width: 100%;" name="nama" required>
							                		<?php
														//Tampilkan Data
														$sql = "SELECT id, nama FROM produk WHERE minimal_quantity IS NULL OR maksimal_quantity IS NULL AND status_hapus='1'";
														$stmt = $db->prepare($sql);
														$stmt->execute();
