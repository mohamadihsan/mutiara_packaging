				            			...
				            			<div class="col-md-4">
				            				<div class="form-group">
				            					<div class="input-group date">
								                  	...
								                  	<input type="text" class="form-control pull-right" id="datepicker" placeholder="Tanggal Pemesanan/Pembelian ...">
								                </div>
				            				</div>
				            			</div>
				            			...
				            			<div class="col-md-12">
				              			...
				              			<div class="col-md-6">
				              				<div class="col-md-12">
						            			...
						            			<div class="col-md-9">
						            				<div class="form-group">
									                	<select class="form-control select" style="width: 100%;" name="nama_bahan_baku" placeholder="Bahan Baku">
									                		<?php
																//Tampilkan Data
